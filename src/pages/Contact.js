...
const Contact = () => {
  ...
  <Nav className='bg-dark p-3 m-0'>
    ...
    <Link onClick={()=>{navigate(-1)}} className='text-center ms-auto text-decoration-none text-white bg-secondary p-2 border border-1 border-dark-subtle rounded'>Go back</Link>
  </Nav>
